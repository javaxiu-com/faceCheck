...
<html>
  ...
  <!-- 左半部默认命名为leftFrame -->
  <frame src="./3/Menu.jsp" name="leftFrame"  id="leftFrame" title="topFrame" />
  <frameset rows="13%,87%" framespacing="0" frameborder="no" border="0">
   <frame src="./3/top.jsp" name="topFrame"  id="topFrame" title="topFrame" scrolling="no" noresize="noresize" />
     <frame src="./3/user.jsp" name="setFrame"  id="setFrame" title="setFrame" />
  </frameset></frameset>
     <noframes><body>
  </body></noframes>
</html>
